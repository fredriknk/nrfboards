...
The ardufox DK (PCA10090) is a single-board development kit for evaluation and
development on the nRF9160 SiP for LTE-M and NB-IoT. The ardufox/nrf9160
...
.. figure:: img/ardufox_nrf9160.jpg
     :align: center
     :alt: ardufox DK

     ardufox DK (Credit: Nordic Semiconductor)

More information about the board can be found at the
`ardufox DK website`_. `nRF9160 Product Specification`_
...
ardufox DK has two external oscillators. The frequency of
...
The ardufox/nrf9160 board configuration supports the following
hardware features:
...
:ref:`application_board_version`). For example, to build for ardufox DK v1.0.0:

.. zephyr-app-commands::
   :tool: all
   :cd-into:
   :board: ardufox/nrf9160@1.0.0
   :goals: build
   :compact:

Remember to also enable routing for this additional hardware in the firmware for
:ref:`ardufox_nrf52840` (see :ref:`ardufox_board_controller_firmware`).

Other hardware features have not been enabled yet for this board.
See `ardufox DK website`_ and `nRF9160 Product Specification`_
for a complete list of ardufox DK board hardware features.
...
ardufox/nrf9160 supports the Armv8m Security Extension, and by default boots
in the Secure state.
...
1. Build the Secure Zephyr application using ``-DBOARD=ardufox/nrf9160`` and
   ``CONFIG_TRUSTED_EXECUTION_SECURE=y`` in the application project configuration file.
2. Build the Non-Secure Zephyr application using ``-DBOARD=ardufox/nrf9160/ns``.
...
1. Build the Non-Secure Zephyr application
   using ``-DBOARD=ardufox_nrf9160_ns``.
...
and :ref:`application_run`), using ``-DBOARD=ardufox/nrf9160``.
...
Replace :code:`<tty_device>` with the port where the ardufox DK
...
Testing the LEDs and buttons in the ardufox DK
**********************************************
...
:zephyr_file:`boards/nordic/ardufox/ardufox_nrf9160_common.dtsi`.
...
The nRF52840 SoC on the ardufox DK (PCA10090) hardware provides support for the
...
buttons, switches, and Arduino pin headers on the ardufox DK board. It is,
...
The ardufox DK has two external oscillators. The frequency of
the slow clock is 32.768 kHz. The frequency of the main clock
is 32 MHz.
...
The ardufox/nrf52840 board configuration supports the following
hardware features:
...
Applications for the ``ardufox/nrf52840`` board configuration can be
...
.. _ardufox_board_controller_firmware:
...
When compiling a project for ardufox/nrf52840, the board controller firmware
...
see the `ardufox DK board control section in the ardufox DK User Guide`_.
...
:zephyr_file:`boards/nordic/ardufox/dts/nrf52840` and
:zephyr_file:`boards/nordic/ardufox/dts/nrf9160`. They can serve as examples of
...
configure the signal routing between nRF9160 and nRF52840 on the ardufox DK.
...
.. code-block:: devicetree
   ...
   #include <nrf52840/ardufox_uart1_on_if0_3.dtsi>

ardufox:

.. code-block:: devicetree

   #include <nrf9160/ardufox_uart1_on_if0_3.dtsi>
...
.. _ardufox DK website: https://www.nordicsemi.com/Software-and-Tools/Development-Kits/nRF9160-DK
...
.. _ardufox DK board control section in the ardufox DK User Guide: https://docs.nordicsemi.com/bundle/ug_nrf9160_dk/page/UG/nrf91_DK/hw_description/nrf9160_board_controller.html
