...
The msensedk/nrf9160 board configuration supports the following
hardware features:
...
msensedk/nrf9160 supports the Armv8m Security Extension, and by default boots
in the Secure state.
...
1. Build the Secure Zephyr application using ``-DBOARD=msensedk/nrf9160`` and
   ``CONFIG_TRUSTED_EXECUTION_SECURE=y`` in the application project configuration file.
2. Build the Non-Secure Zephyr application using ``-DBOARD=msensedk/nrf9160/ns``.
...
1. Build the Non-Secure Zephyr application
   using ``-DBOARD=msensedk_nrf9160_ns``.
...
and :ref:`application_run`), using ``-DBOARD=msensedk/nrf9160``.
...
:zephyr_file:`boards/nordic/msensedk/msensedk_nrf9160_common.dtsi`.
...
The msensedk/nrf52840 board configuration supports the following
hardware features:
...
Applications for the ``msensedk/nrf52840`` board configuration can be
...
.. _msensedk_board_controller_firmware:
...
When compiling a project for msensedk/nrf52840, the board controller firmware
...
:zephyr_file:`boards/nordic/msensedk/dts/nrf52840` and
...
.. code-block:: devicetree
   ...
   #include <nrf9160/msensedk_uart1_on_if0_3.dtsi>
