...
development on the nRF9160 SiP for LTE-M and NB-IoT. The nrf9160devkittest/nrf9160
...
.. figure:: img/nrf9160devkittest_nrf9160.jpg
     :align: center
     :alt: nRF9160 DK
...
The nrf9160devkittest/nrf9160 board configuration supports the following
hardware features:
...
.. _nrf9160devkittest_additional_hardware:
...
.. zephyr-app-commands::
   :tool: all
   :cd-into:
   :board: nrf9160devkittest/nrf9160@1.0.0
   :goals: build
   :compact:

Remember to also enable routing for this additional hardware in the firmware for
:ref:`nrf9160devkittest_nrf52840` (see :ref:`nrf9160devkittest_board_controller_firmware`).
...
nrf9160devkittest/nrf9160 supports the Armv8m Security Extension, and by default boots
in the Secure state.
...
1. Build the Secure Zephyr application using ``-DBOARD=nrf9160devkittest/nrf9160`` and
   ``CONFIG_TRUSTED_EXECUTION_SECURE=y`` in the application project configuration file.
2. Build the Non-Secure Zephyr application using ``-DBOARD=nrf9160devkittest/nrf9160/ns``.
...
1. Build the Non-Secure Zephyr application
   using ``-DBOARD=nrf9160devkittest_nrf9160_ns``.
...
and :ref:`application_run`), using ``-DBOARD=nrf9160devkittest/nrf9160``.
...
.. zephyr-app-commands::
   ...
   :board: nrf9160devkittest/nrf9160
   :goals: build flash
...
:zephyr_file:`boards/nordic/nrf9160devkittest/nrf9160devkittest_nrf9160_common.dtsi`.

.. _nrf9160devkittest_nrf52840:
...
The nrf9160devkittest/nrf52840 board configuration supports the following
hardware features:
...
Applications for the ``nrf9160devkittest/nrf52840`` board configuration can be
...
.. zephyr-app-commands::
   :zephyr-app: samples/hello_world
   :board: nrf9160devkittest/nrf52840
   :goals: build flash
...
.. _nrf9160devkittest_board_controller_firmware:
...
When compiling a project for nrf9160devkittest/nrf52840, the board controller firmware
...
:zephyr_file:`boards/nordic/nrf9160devkittest/dts/nrf52840` and
:zephyr_file:`boards/nordic/nrf9160devkittest/dts/nrf9160`. They can serve as examples of
...
.. code-block:: devicetree
   ...
   #include <nrf52840/nrf9160devkittest_uart1_on_if0_3.dtsi>

nRF9160:

.. code-block:: devicetree

   #include <nrf9160/nrf9160devkittest_uart1_on_if0_3.dtsi>
